module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const reply = data.choices && data.choices[0] && data.choices[0].message
      ...
      : "This section is currently under construction and will be live soon. Feel free to reach out at mkshitij007@gmail.com";
    ...
    return res.status(200).json({
      reply: "This section is currently under construction and will be live soon. Feel free to reach out at mkshitij007@gmail.com"
    });
  }
};
